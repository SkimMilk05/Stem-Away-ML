...
cats = 'Get Help,General Programming'
# Find the number of pages in categories to determine the range
for i in range(0, 15):
    # Add the URL to the category page you have to scrape
    URL = 'https://discuss.codecademy.com/c/get-help/general-programming/1805?page='+str(i)
...
generalProgrammingcsv = pd.DataFrame({'Title': titles,
...
print(generalProgrammingcsv.info())

generalProgrammingcsv.to_csv('generalProgrammingcsv.csv')