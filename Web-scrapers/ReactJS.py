...
for i in range(0, 15):
    ...
    URL = 'https://discuss.codecademy.com/c/get-help/React/1822?page='+str(i)
...
ReactJScsv = pd.DataFrame({'Title': titles,
...
print(ReactJScsv.info())

ReactJScsv.to_csv('ReactJScsv.csv')