...
for i in range(0, 15):
    ...
    URL = 'https://discuss.codecademy.com/c/faq/Python-FAQ/1793?page='+str(i)
...
pythonFAQcsv = pd.DataFrame({'Title': titles,
...
print(pythonFAQcsv.info())

pythonFAQcsv.to_csv('pythonFAQcsv.csv')